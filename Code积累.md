...
- web与servlet
  ...
  - 前端Request Headers: `Accept: application/json, text/javascript, */*; q=0.01` 通知后端我接收的数据格式
  - 前端Request Headers: `Content-Type: text/plain; charset=UTF-8` 
  - 前端Response Headers: `Content-Type: text/html; charset=utf-8` 后端返回的数据格式
